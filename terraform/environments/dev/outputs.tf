output "alb_dns_name"          { value = module.alb.alb_dns_name  description = "Public URL of the API" }
...
output "github_deploy_role"    { value = module.github_oidc.role_arn }
output "cloudwatch_dashboard"  { value = module.monitoring.dashboard }
